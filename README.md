...
If a have a 2-bit binary umber the number of possible pattern for these two numbers are 00,01,10,11. Only these are the 4 combinations of a 2-binary number. The number of possiblities of minary number having `n` number of bits can be clculated by tthe following formula:
2^n
